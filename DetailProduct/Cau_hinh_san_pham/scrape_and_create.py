...
soup0= soup0.find('ul', class_='homeproduct filter-cate')
for a in soup0.findAll('a', href=True):
    if a.text:
        product_name = a.find('h3').text
        link1 = "{0}{1}".format("https://www.thegioididong.com",a['href'])
        if link1 == "https://www.thegioididong.com/dtdd/xiaomi-redmi-5-plus":
            pass
        else:
